...
<div id="wrapper">
            ...
            <div class="container mt-5">
                ...
                <form id="editPlaceForm">
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control" id="placeCompany" name="companyId" required>
    ...
    <!-- Custom JS for place management -->
    <script src="{{ asset('assets/js/admin/place/editPlace.js') }}"></script>
